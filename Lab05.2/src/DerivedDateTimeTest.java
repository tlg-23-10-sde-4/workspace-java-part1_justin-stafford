...
import static java.time.DayOfWeek.*;  //MONDAY insteadof DayofWeek.MONDAY  // for the enum constants

import static java.time.temporal.TemporalAdjusters.*;  // factory class for creating adjusters for dates
...
class DerivedDateTimeTest {
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1973,4,9);
        LocalDate rday = bday.plusYears(59).plusMonths(6);
    ...
    public static void testLaborDay() {
        LocalDate sept1 = LocalDate.of(1973,4,9);
...
//        LocalDate laborDay = nov2.with(TemporalAdjusters.nextOrSame(DayOfWeek.TUESDAY));
    ...
    public static void testAnniversary() {
        ...
        LocalDate party = anniversary.with(TemporalAdjusters.nextOrSame(SATURDAY));
